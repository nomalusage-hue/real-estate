  ...
  return (
    <div className="properties-sidebar">
      <div className="filter-widget">
          ...
          <div className="property-type-filter">
            <div className="form-check mb-2">
              <input
                ...
                type="checkbox"
                id="type-all"
                checked={!localFilters.propertyTypes || localFilters.propertyTypes.length === 0}
          ...
          <div className="bedroom-filter d-flex flex-wrap gap-2">
            {/* {bedroomOptions.map((option) => {
              const isActive = option === 'Any'
                ...
                : localFilters.minBedrooms === parseInt(option.replace('+', ''));
            ...
            {bedroomOptions.map((option) => {
              const isActive = option === 'Any'
                ? !localFilters.minBedrooms && !localFilters.maxBedrooms // Check both
                : localFilters.minBedrooms === parseInt(option.replace('+', ''));
          ...
          <div className="bathroom-filter d-flex flex-wrap gap-2">
            {bathroomOptions.map((option) => {
              const isActive = option === 'Any'
                ...
                : localFilters.minBathrooms === parseInt(option.replace('+', ''));
          ...
          <div className="row g-2">
            <div className="col-6">
              <input
                ...
                value={localFilters.minBuildingSize || localFilters.minLandSize || ''}
                onChange={(e) => {
                  const value = e.target.value ? parseInt(e.target.value) : undefined;
                  handleNumericFilter('minBuildingSize', 'maxBuildingSize', value, localFilters.maxBuildingSize);
                }}
              />
            </div>
            <div className="col-6">
              <input
                ...
                value={localFilters.maxBuildingSize || localFilters.maxLandSize || ''}
                onChange={(e) => {
                  const value = e.target.value ? parseInt(e.target.value) : undefined;
                  handleNumericFilter('minBuildingSize', 'maxBuildingSize', localFilters.minBuildingSize, value);
                }}
              />
            </div>
          </div>
          ...
          <div className="features-filter">
            ...
            <div className="form-check mb-2">
              <input
                ...
                type="checkbox"
                id="has-garden"
                checked={localFilters.hasGarden || false}
          ...
          <div className="labels-filter">
            <div className="form-check mb-2">
              <input
                ...
                type="checkbox"
                id="hot-label"
                checked={localFilters.hot || false}
            ...
            <div className="form-check mb-2">
              <input
                ...
                type="checkbox"
                id="new-label"
                checked={localFilters.newListing || false}
        ...
        >
          Apply Filters ({Object.keys(localFilters).length})
        </button>
      </div>
